...
var makeMemoCop = async function (copUrl,x,y,pageNum,memoNum, pdfName){
  var posX = x;
  var posY = y;

  const existingPdfBytes = await fetch(copUrl).then(res => res.buffer());
